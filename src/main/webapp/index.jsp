...
<body>
    <header>
        <h1>Surya Paul Prem - DevOps Engineer</h1>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Surya Paul Prem, a DevOps Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
